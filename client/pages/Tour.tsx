  ...
  const tours = [
    {
      ...
      description: "Experience the majestic Himalayan peaks and cultural heritage",
      fullDescription: "Journey through the stunning landscapes of Nepal, from Kathmandu's ancient temples to the breathtaking vistas of the Annapurna region.",
      price: 1299,
      duration: "10 days",
      ...
      spotsLeft: 5,
      coordinates: [28.3949, 84.1240], // Nepal
      highlights: [
    ...
    },
    {
      ...
      description: "Discover ancient monasteries and spiritual practices",
      fullDescription: "Immerse yourself in the profound spirituality of Tibet, visiting sacred monasteries and experiencing Buddhist traditions firsthand.",
      price: 1599,
      duration: "12 days",
      ...
      badges: ["Spiritual"],
      spotsLeft: 8,
      coordinates: [29.6470, 91.1175], // Tibet/Lhasa
      highlights: [
        "Visit Potala Palace in Lhasa",
        "Attend prayer ceremonies with monks",
        "Explore remote mountain monasteries",
        "Experience Tibetan meditation practices",
      ],
    },
    {
      id: 3,
      ...
      description: "Immerse in Bhutanese culture and wellness practices",
      fullDescription: "Rejuvenate your body and mind in the Land of Happiness with traditional wellness treatments and spiritual practices.",
      price: 1899,
      duration: "8 days",
      groupSize: "4-8 people",
      vibe: "Wellness & Culture",
      difficulty: 1,
      rating: 4.9,
      reviewCount: 156,
      badges: ["Luxury", "Limited Spots"],
      spotsLeft: 2,
      coordinates: [27.4716, 89.6386], // Bhutan
      highlights: [
        "Traditional Bhutanese hot stone baths",
    ...
    },
    {
      ...
      description: "Explore palaces, temples, and vibrant desert culture",
      fullDescription: "Travel through the colorful state of Rajasthan, exploring magnificent palaces, ancient forts, and the golden Thar Desert.",
      price: 899,
      duration: "7 days",
      ...
      rating: 4.7,
      reviewCount: 312,
      badges: ["Best Value", "City"],
      spotsLeft: 12,
      coordinates: [26.9124, 75.7873], // Jaipur, Rajasthan
      highlights: [
        "Explore Jaipur's City Palace",
    ...
    },
    {
      ...
      description: "Serene backwaters, spice plantations, and beach retreats",
      fullDescription: "Cruise through Kerala's tranquil backwaters on traditional houseboats and discover the lush beauty of 'God's Own Country.'",
      price: 799,
      duration: "6 days",
      groupSize: "8-12 people",
      ...
      badges: ["Historical"],
      spotsLeft: 15,
      coordinates: [9.9312, 76.2673], // Kerala
      highlights: [
        "Houseboat cruise through backwaters",
        "Visit spice plantation gardens",
    ...
    },
    {
      ...
      description: "Dramatic landscapes, glaciers, and mountain trekking",
      fullDescription: "Embark on an epic adventure through one of the world's last great wildernesses, featuring stunning glaciers and rugged peaks.",
      price: 2299,
      duration: "14 days",
      groupSize: "6-10 people",
      vibe: "Extreme Trekking",
      difficulty: 4,
      rating: 4.9,
      reviewCount: 142,
      badges: ["Educational", "Popular"],
      spotsLeft: 4,
      coordinates: [-49.3306, -73.0511], // El Calafate, Patagonia
      highlights: [

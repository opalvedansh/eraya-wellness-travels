...
const TREKS_DATA = [
    {
        ...
        description: "A stunning trek to the base of the Annapurna massif",
        difficulty: 3,
        duration: "10 days",
        price: 1299,
        altitude: "4,130m",
    ...
    },
    {
        ...
        description: "The world's most famous trek to the base of Mount Everest",
        difficulty: 4,
        duration: "14 days",
        price: 1799,
        altitude: "5,364m",
    ...
    },
    {
        ...
        name: "Gokyo",
        slug: "gokyo",
        coordinates: { lat: 27.9519, lng: 86.6906 },
        description: "Experience pristine turquoise lakes and stunning mountain views",
        difficulty: 4,
        duration: "12 days",
        price: 1699,
        altitude: "4,790m",
    ...
    },
    {
        ...
        name: "Manaslu Trek",
        slug: "manaslu-trek",
        coordinates: { lat: 28.5497, lng: 84.5595 },
        description: "Off-the-beaten-path trek around the eighth highest mountain",
        difficulty: 4,
        duration: "14 days",
        price: 1599,
        altitude: "5,106m",
    ...
    },
    {
        ...
        coordinates: { lat: 28.5497, lng: 84.5595 },
        description: "Complete circuit trek with challenging high passes",
        difficulty: 4,
        duration: "16 days",
        price: 1599,
        altitude: "5,106m",
    ...
    },
    {
        ...
        coordinates: { lat: 28.2100, lng: 85.5600 },
    ...
    },
    {
        ...
        name: "Makalu Barun",
        slug: "makalu-barun",
        coordinates: { lat: 27.8897, lng: 87.0889 },
    ...
    },
    {
        ...
        name: "Ama Yangri",
        slug: "ama-yangri",
        coordinates: { lat: 27.9167, lng: 85.4667 },
    ...
    },
    {
        ...
        name: "Dolpo",
        slug: "dolpo",
        coordinates: { lat: 29.0000, lng: 82.8000 },
    ...
    },
    {
        ...
        name: "Dhorpatan",
        slug: "dhorpatan",
        coordinates: { lat: 28.5167, lng: 82.8333 },
    ...
    },
    {
        ...
        name: "Shey Phoksundo",
        slug: "shey-phoksundo",
        coordinates: { lat: 29.2333, lng: 82.9500 },
...
export default function TreksMap() {
    ...
    const [hoveredTrek, setHoveredTrek] = useState<number | null>(null);
            ...
            try {
                ...
                filteredTreks.forEach((trek) => {
                        ...
                        <div style="padding: 20px; max-width: 320px; font-family: Inter, sans-serif;">
                            ...
                            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 16px;">
                                <div style="text-align: center; padding: 12px; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 12px;">
                                    ...
                                    <div style="font-size: 16px; font-weight: 700; color: #1a1a1a;">${trek.duration}</div>
                                </div>
                                <div style="text-align: center; padding: 12px; background: linear-gradient(135deg, #d4edda 0%, #c3e6cb 100%); border-radius: 12px;">
                                    ...
                                    <div style="font-size: 16px; font-weight: 700; color: #155724;">$${trek.price}</div>
                                </div>
                                <div style="text-align: center; padding: 12px; background: linear-gradient(135deg, #fff3cd 0%, #ffeaa7 100%); border-radius: 12px;">
                                    ...
                                    <div style="font-size: 16px; font-weight: 700; color: #856404;">★ ${trek.rating}</div>
                                </div>
                            </div>
                            <div style="display: flex; gap: 10px;">
                                ...
                                <button 
                                    onclick="window.location.href='/booking/trek/${trek.slug}'"
                    ...
                    marker.addListener("click", () => {
                        ...
                        // Desktop: Scroll to the corresponding trek card in sidebar
    ...
    }, []); // Only initialize map once - don't depend on filteredTreks

    // Separate effect to update markers when filteredTreks changes (without reloading map)
    useEffect(() => {
        ...
        // Create markers for current filtered treks
        filteredTreks.forEach((trek) => {
            const marker = new google.maps.Marker({
                position: trek.coordinates,
                map: map,
    ...
    }, [filteredTreks, isLoading]);

    const handleTrekClick = (trek: typeof TREKS_DATA[0]) => {
        setSelectedTrek(trek.id);

        if (mapInstanceRef.current) {
            // Smooth pan to marker location
            mapInstanceRef.current.panTo(trek.coordinates);
            mapInstanceRef.current.setZoom(10);

            // Find and trigger the marker
            const marker = markersRef.current.find((m) => (m as any).trekId === trek.id);
            if (marker) {
    ...
    const handleTrekHover = (trekId: number | null) => {
        setHoveredTrek(trekId);

        if (trekId !== null) {
            // Highlight the corresponding marker
            const marker = markersRef.current.find((m) => (m as any).trekId === trekId);
            if (marker) {
                marker.setIcon({
                    path: google.maps.SymbolPath.CIRCLE,
                    scale: 18,
    ...
    return (
        <div className="h-screen bg-beige flex flex-col overflow-hidden">
            ...
            <div className="flex-1 flex relative overflow-hidden pt-20">
                                ...
                                <div className="p-6 space-y-6">
                                    ...
                                    >
                                        <p className="text-sm font-bold text-text-dark/70 flex items-center gap-2">
                                            ...
                                            {filteredTreks.length} adventure{filteredTreks.length !== 1 ? 's' : ''} await
                                        </p>
                                    </motion.div>
                                        ...
                                        <AnimatePresence mode="popLayout">
                                            {filteredTreks.map((trek, index) => (
                                                <motion.button
                                                    ...
                                                    onMouseEnter={() => handleTrekHover(trek.id)}
                                                    onMouseLeave={() => handleTrekHover(null)}
                                                    className={`w-full text-left relative overflow-hidden rounded-xl transition-all duration-300 ${selectedTrek === trek.id
                                                    ...
                                                    <div className="relative p-5 space-y-3">
                                                        ...
                                                        <div className="flex items-start justify-between gap-3">
                                                            ...
                                                            <div className="flex flex-col items-center gap-1 bg-gradient-to-br from-yellow-50 to-orange-50 px-3 py-2 rounded-xl border border-yellow-200">
                                                                ...
                                                                <span className="text-xs font-bold text-yellow-700">{trek.rating}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="grid grid-cols-3 gap-2">
                                                            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-2 text-center border border-border/30">
                                                                ...
                                                                <div className="text-xs font-bold text-text-dark">{trek.duration}</div>
                                                            </div>
                                                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-2 text-center border border-green-200">
                                                                <div className="flex items-center justify-center gap-1 mb-1">
                                                                    <DollarSign className="h-3 w-3 text-green-600" />
                                                                </div>
                                                                <div className="text-xs font-bold text-green-700">${trek.price}</div>
                                                            </div>
                                                            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-2 text-center border border-border/30">
                                                                <div className="flex items-center justify-center gap-1 mb-1">
                                                                    <TrendingUp className="h-3 w-3 text-purple-500" />
                                                                </div>
                                                                <div className="text-xs font-bold text-text-dark">{trek.altitude}</div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div className="flex gap-1">
                                                                {[...Array(5)].map((_, i) => (
                                                                    <motion.div
                                                                        ...
                                                                        className={`h-2 w-2 rounded-full transition-all ${i < trek.difficulty
                                                                            ? `bg-${trek.difficulty <= 2 ? 'green' :
                                                                                trek.difficulty === 3 ? 'yellow' :
                                                                                    trek.difficulty === 4 ? 'orange' : 'red'
                                                                            }-500 shadow-md`
                                                                            : "bg-gray-200"
                                                                            }`}
                                                                        style={{
                                                                            backgroundColor: i < trek.difficulty ? getDifficultyColor(trek.difficulty) : '#e5e7eb'
                                                                        }}
                                                                    />
                                                                ))}
                                                            </div>
                                                            <span className="text-xs font-bold" style={{ color: getDifficultyColor(trek.difficulty) }}>
                ...
                {/* Mobile Bottom Sheet with Trek Cards */}
                <MapBottomSheet
                    ...
                    <div ref={bottomSheetScrollRef} className="p-4 space-y-4">
                        ...
                        {filteredTreks.map((trek) => (
                            <motion.button
                                ...
                                ref={(el) => { trekCardRefs.current[trek.id] = el; }}
                                onClick={() => handleTrekClick(trek)}
                                className={`w-full bg-white rounded-xl shadow-sm transition-all ${selectedTrek === trek.id
                            ...
                            >
                                <div className="flex gap-3 p-3">
                                    {/* Image Placeholder */}
                                    <div className="relative w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center">
                                        <Mountain className="h-10 w-10 text-green-primary" />
                                        {selectedTrek === trek.id && (
                                    ...
                                    <div className="flex-1 min-w-0 text-left">
                                        ...
                                        <div className="flex items-center gap-3 text-xs">
                                            ...
                                            <span className="text-yellow-600">★ {trek.rating}</span>
                                        </div>
                                    </div>
                    ...
                    {isLoading && (
                        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-beige to-beige-light z-10">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-text-dark/60 mt-2">Preparing 14 epic treks</p>
                            </div>
                        </div>
                    )}
                    ...
                    {!isLoading && !error && (
                        ...
                        >
                            <div className="bg-white/95 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-gray-200 flex items-center gap-2">
                                ...
                                <span className="text-sm font-semibold text-text-dark">Click a marker to explore trek details</span>
                            </div>
                        </motion.div>
                    )}
                </div>

    ...
    >
      <div className="bg-card rounded-xl shadow-premium-lg border border-border p-6 space-y-4">
        <div className="text-center">
          ...
          <p className="text-4xl font-black text-green-primary">${tour.price}</p>
        ...
        <div className="space-y-3 border-t border-b border-border py-4">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold">{tour.rating}/5 ({tour.reviewCount})</span>
          </div>
        </div>
...
function SimilarToursCarousel({ tours, currentTourId }: any) {
  const [emblaRef] = useEmblaCarousel({ loop: false, align: "start" });
  const navigate = useNavigate();

  const similarTours = tours.filter((t: any) => t.id !== currentTourId).slice(0, 4);
          ...
          >
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="font-bold text-text-dark mb-2 line-clamp-2">{tour.name}</h3>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-black text-green-primary">${tour.price}</span>
                  <span className="text-sm text-text-dark/60">{tour.duration}</span>
                </div>
              </div>
            </div>
          </div>
  ...
  const tourDatabase = [
    {
      ...
      faqs: [
        {
          ...
          a: "This tour requires moderate fitness. We'll do some hiking at altitude, but nothing too strenuous. If you can walk 3-4 hours with breaks, you'll be fine.",
        },
        {
      ...
      reviews: [
        ...
        },
        {
          ...
          rating: 4,
          date: "September 2024",
          text: "Wonderful tour overall. The only reason I didn't give 5 stars is that one of the accommodations was a bit basic, but the experience more than made up for it. The team was responsive to our needs and the itinerary was well-paced.",
          verified: true,
        },
        ...additionalNepalReviews,
      ],
      route: nepalRouteCoordinates,
      itinerary: [
        {
          day: "Day 1-2",
    ...
    },
    {
      ...
      included: [
        ...
        { item: "Cultural Tours", detail: "Dzongs and temples", included: true },
    ...
    },
    {
      ...
      reviews: [
        ...
        },
        {
          ...
          rating: 5,
          date: "December 2024",
          text: "Perfect for relaxation. The Ayurvedic massage was incredible, and the spice plantation tour was fascinating. Great food throughout!",
          verified: true,
        },
      ],
      itinerary: [
        ...
        { day: "Day 3", title: "Spice Garden Tour", description: "Visit spice plantation, learn about cardamom, pepper, vanilla cultivation." },
    ...
    },
    {
      ...
      itinerary: [
        { day: "Day 1-2", title: "Buenos Aires", description: "Arrive in Buenos Aires. City tour and tango performances." },
    ...
    const fetchTour = async () => {
      ...
      try {
        ...
        const transformedTour = {
          ...
          reviews: [],
          route: itineraryRoute.length > 0 ? itineraryRoute : (data.route || []),
        };
    ...
    return (
      <div className="min-h-screen bg-beige flex flex-col">
        ...
        <div className="flex-grow flex flex-col items-center justify-center px-4 py-12">
          <h1 className="text-3xl font-black text-green-primary mb-4">Tour Not Found</h1>
          <p className="text-text-dark/70 mb-8">The tour you're looking for doesn't exist.</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-beige flex flex-col">
      ...
      <section className="px-3 sm:px-6 lg:px-12 max-w-7xl mx-auto w-full mb-10 sm:mb-14 lg:mb-20">
        <PhotoGallery images={tour.gallery || [tour.image]} />
            ...
            <div className="flex-grow">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-text-dark/60">({tour.reviewCount} reviews)</span>
                </div>
              </div>
            </div>
            <div className="text-left sm:text-right shrink-0">
              <p className="text-sm text-text-dark/60 mb-1">Starting from</p>
              <p className="text-4xl sm:text-5xl font-black text-green-primary">${tour.price}</p>
            ...
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6">
                <div className="bg-card rounded-xl p-6 shadow-premium-sm border border-border">
                  ...
                  <p className="text-xl font-black text-text-dark">{tour.duration}</p>
                </div>
                <div className="bg-card rounded-xl p-6 shadow-premium-sm border border-border">
                  ...
                  <p className="text-xl font-black text-text-dark">{tour.groupSize}</p>
                </div>
                <div className="bg-card rounded-xl p-6 shadow-premium-sm border border-border">
                  ...
                  <p className="text-xl font-black text-text-dark">{tour.location}</p>
                </div>
              </div>
            </div>
      ...
      <section className="px-3 sm:px-6 lg:px-12 max-w-7xl mx-auto w-full mb-14 sm:mb-18 bg-beige-light py-12 -mx-3 sm:-mx-6 lg:-mx-12">
        <div className="px-3 sm:px-6 lg:px-12">
          ...
          <SimilarToursCarousel tours={tourDatabase} currentTourId={tour.id} />
        </div>
      </section>

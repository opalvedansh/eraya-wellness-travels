...
export default function About() {
  ...
  const milestones: Milestone[] = (aboutContent?.milestones as Milestone[]) || defaultMilestones;
  const teamMembers: TeamMember[] = (aboutContent?.team as TeamMember[]) || defaultTeamMembers;
  const partners: Partner[] = (aboutContent?.partners as Partner[]) || defaultPartners;

        ...
        <AdminLayout>
            <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                    <button onClick={() => router.push("/admin/tours")} className="p-2 hover:bg-gray-100 rounded-lg transition">
                ...
                <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button type="button" onClick={() => router.push("/admin/tours")} className="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">Cancel</button>
                    </div>
                </form>
            </div>
        </AdminLayout>

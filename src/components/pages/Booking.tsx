...
export default function Booking() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Payments disabled - redirect to confirmation page
      ...
      sessionStorage.setItem("paymentConfirmationData", JSON.stringify(confirmationData));
      ...
      <div className="relative bg-gradient-to-br from-green-primary/5 via-beige to-beige-light pt-20 sm:pt-24 md:pt-28 pb-12 sm:pb-16">
        ...
        <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-12">
          ...
          <div className="flex items-center gap-2 text-sm mb-8">
            <Link href="/" className="text-text-dark/60 hover:text-green-primary transition-colors">Home</Link>
            <span className="text-text-dark/40">→</span>
            <Link href={`/${type}`} className="text-text-dark/60 hover:text-green-primary transition-colors capitalize">{type}s</Link>
            <span className="text-text-dark/40">→</span>

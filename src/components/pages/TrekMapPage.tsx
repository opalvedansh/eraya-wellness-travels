            ...
            <div className="flex-1 flex overflow-hidden relative">
                        ...
                        <AnimatePresence>
                            {filteredAndSortedTreks.map((trek, index) => (
                                <motion.div
                                    ...
                                    ref={(el) => { if (el) itemRefs.current[trek.id] = el; }}
                ...
                <div className="flex-1 relative h-full pb-0 lg:pb-0" style={{ paddingBottom: window.innerWidth < 1024 ? '200px' : '0' }}>
                    <Suspense fallback={
                        ...
                        <TrekMap
                            treks={mapTreks}
                            onTrekClick={(slug) => router.push(`/trek/${slug}`)}
                    ...
                    <div className="px-6 pb-3 border-b border-gray-100">
                        <div className="flex items-center justify-between mb-3">
                            <h3 className="text-lg font-bold text-text-dark">
                                {filteredAndSortedTreks.length} Treks Found
                            </h3>
                            <button
                        ...
                        <div className="divide-y divide-gray-100">
                            {filteredAndSortedTreks.map((trek, index) => (
                                <motion.div
                                    ...
                                    onClick={() => setSelectedTrekId(trek.id)}
                                    className={`p-4 cursor-pointer transition-all ${selectedTrekId === trek.id
